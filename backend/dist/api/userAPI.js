...
router.get('/:id/plan', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const planQuery = yield userController_1.default.getPlanOfUser(id, planIndex);
    if (planQuery) {
...
router.patch('/:id/plan', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const updatePlanQuery = yield userController_1.default.updatePlanOfUser(req.params['id'], req.body['plan'], req.body['planIndex']);
    if (updatePlanQuery) {
        res.status(200).send({});
    }
    else {
